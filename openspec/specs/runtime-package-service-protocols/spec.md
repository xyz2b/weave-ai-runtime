# runtime-package-service-protocols Specification

## Purpose
TBD - created by archiving change eliminate-privileged-runtime-package-service-slots. Update Purpose after archive.
## Requirements
