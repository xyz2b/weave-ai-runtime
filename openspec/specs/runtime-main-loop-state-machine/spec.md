# runtime-main-loop-state-machine Specification

## Purpose
TBD - created by archiving change align-runtime-main-loop-state-machine. Update Purpose after archive.
## Requirements
...
- **WHEN** [engine.py](/Users/xyzjiao/AIProject/AIAgentRuntime/src/claude_agent_runtime/turn_engine/engine.py) handles an assistant attempt that stops because the model emitted tool use
...
- **WHEN** [agent_execution_service.py](/Users/xyzjiao/AIProject/AIAgentRuntime/src/claude_agent_runtime/agent_execution_service.py#L202) classifies the result of `run_turn()`
