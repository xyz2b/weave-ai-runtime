...
- **WHEN** [engine.py](../../../src/runtime/turn_engine/engine.py) handles an assistant attempt that stops because the model emitted tool use
...
- **WHEN** [agent_execution_service.py](../../../src/runtime/agent_execution_service.py#L202) classifies the result of `run_turn()`
