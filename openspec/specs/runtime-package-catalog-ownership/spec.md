# runtime-package-catalog-ownership Specification

## Purpose
TBD - created by archiving change dekernelize-first-party-package-catalog-and-enforce-protocol-conformance. Update Purpose after archive.
## Requirements
