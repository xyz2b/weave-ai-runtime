...
- [x] 1.2 Implement de-duplicated upward discovery of nested `.claude/skills` roots from observed workspace paths.
...
- [x] 4.2 Add Claude-compatible shell block parsing for local file-backed skills.
