...
OFFICIAL_RUNTIME_PACKAGE_CATALOG: dict[str, OfficialRuntimePackageCatalogEntry] = {
    ...
    "weavert-memory": _official_manifest(
        ...
        assembly_entrypoint="weavert_memory.package:assemble_runtime_memory_package",
    ...
    "weavert-team": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_team.assembly:assemble_runtime_team_package",
    ...
    "weavert-compaction": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_compaction.package:assemble_runtime_compaction_package",
    ...
    "weavert-isolation": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_isolation.package:assemble_runtime_isolation_package",
        distribution_defaults=("weavert-full",),
    ),
    "weavert-openai": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_openai.package:assemble_runtime_openai_package",
        distribution_defaults=("weavert-full",),
    ),
    "weavert-hosts-reference": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_hosts_reference.package:assemble_runtime_hosts_reference_package",
        distribution_defaults=("weavert-full",),
    ),
    "weavert-stores-file": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_stores_file.package:assemble_runtime_stores_file_package",
        distribution_defaults=("weavert-full",),
    ),
    "weavert-builtin-workflows": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_builtin_workflows.package:assemble_runtime_builtin_workflows_package",
    ...
    "weavert-planning": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_planning.package:assemble_runtime_planning_package",
    ...
    "weavert-devtools": _official_manifest(
        ...
        dependencies=("weavert-core",),
        assembly_entrypoint="weavert_devtools.package:assemble_runtime_devtools_package",
